**Task:** This project aims to choose one executive + department pair (Finance, Sales, Operations, or HR), build a clear strategic dashboard from AdventureWorks data, and prepare two tailored presentations (a ~5-minute executive pitch and a ~10-minute departmental briefing). The dashboard must be executive-ready—well labeled, branded, and structured—while supporting deeper tactical insights for the department lead, include data sources/SQL, clear metrics, and recommended next steps; presentations should explain the problem, key findings, business impact, limitations, and actionable recommendations.
...
AdventureWorks demonstrates strong revenue growth (178% YoY in 2002–2003), but untapped potential exists due to:
- Regional imbalances: US Southeast/Northeast/Central underperform despite high market potential.
- Online channel gaps: 23% online sales (below industry 20–30% benchmark)
- Data blind spots: 24% of online sales lack tracked reasons, limiting customer insights.
- Low performance of some products and promotional campaigns

**2. Importance**

This leaves potential online revenue unaddressed and results in inefficient resource allocation (e.g., low-performing products, promotions). The current 23% online sales fall short of the industry standard of 20-30%, missing a potential $9.85M in additional revenue. Poor tracking obscures customer preferences, risking missed growth opportunities in a competitive market with a projected $8.6B U.S. bicycle industry in 2024.

**3. Proposed Solution and Organizational Benefits**

A strategic shift to double down on the US (58.6% of revenue), and close the 7% gap to industry standards (30% online share) can drive growth. This includes:
- Big Picture: Strengthens market position in the US and aligns with global trends, supporting a 36.19% YoY growth trajectory.
